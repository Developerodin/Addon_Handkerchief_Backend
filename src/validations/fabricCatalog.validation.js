...
const fabricCatalogBody = {
  ...
  millOldFabricSortNo: Joi.string().allow(''),
  millNewFabricSortNo: Joi.string().allow(''),
  fabricType: lookupId,
  color: lookupId,
  quality: lookupId,
  yarn: lookupId,
  ...
  design: Joi.string().valid('', 'Plain', 'Print'),
  wash: Joi.string().valid('', 'Yes', 'No'),
  finish: Joi.string().valid('', 'NA', 'N9', 'Silverdor', 'Anti Micobacterial'),
