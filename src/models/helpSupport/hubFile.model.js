...
/**
 * @typedef HelpSupportHubFile
 */
const HelpSupportHubFile = mongoose.model('HelpSupportHubFile', fileManagerSchema);

export default HelpSupportHubFile; 